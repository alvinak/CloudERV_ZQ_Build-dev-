...
IMPLEMENT_DYNCREATE(CPdfReportFrame, CChildFrame)

CPdfReportFrame::CPdfReportFrame()
{
...
BEGIN_MESSAGE_MAP(CPdfReportFrame, CChildFrame)
	ON_WM_CREATE()
END_MESSAGE_MAP()
...
CChildFrame::CaptionToolBarButtonInfo * CPdfReportFrame::GetCaptionToolBarButtonInfoList() 
{ 
	return (CChildFrame::CaptionToolBarButtonInfo *)g_lstButtonsOfPdfReport;
}

// CPdfReportFrame message handlers

int CPdfReportFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
